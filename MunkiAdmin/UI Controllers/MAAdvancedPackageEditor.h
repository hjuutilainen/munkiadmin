...
@property (assign) IBOutlet NSTabViewItem *preinstallScriptTabViewItem;
@property (assign) IBOutlet NSTextView *preinstallScriptTextView;
@property (assign) IBOutlet NSTabViewItem *postinstallScriptTabViewItem;
@property (assign) IBOutlet NSTextView *postinstallScriptTextView;
@property (assign) IBOutlet NSTabViewItem *uninstallScriptTabViewItem;
...
@property (assign) IBOutlet NSTabViewItem *preuninstallScriptTabViewItem;
@property (assign) IBOutlet NSTextView *preuninstallScriptTextView;
@property (assign) IBOutlet NSTabViewItem *postuninstallScriptTabViewItem;
@property (assign) IBOutlet NSTextView *postuninstallScriptTextView;
@property (assign) IBOutlet NSTabViewItem *installCheckScriptTabViewItem;
@property (assign) IBOutlet NSTextView *installCheckScriptTextView;
@property (assign) IBOutlet NSTabViewItem *uninstallCheckScriptTabViewItem;
